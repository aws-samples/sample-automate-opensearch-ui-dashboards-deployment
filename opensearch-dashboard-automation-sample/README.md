# Automated OpenSearch Dashboard Deployment with AWS CDK

This sample demonstrates how to automate Amazon OpenSearch UI workspace and dashboard creation using AWS CDK, AWS Lambda, and the OpenSearch Saved Objects API.
...
git clone https://github.com/aws-samples/opensearch-dashboard-automation-sample.git
